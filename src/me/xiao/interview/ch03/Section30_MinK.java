 ...
 * 数组里面最小的k个数
 * <p>
 * 1， 可以基于快排的思想，找到第k个小的数，然后前面的都是
 * 2， 大顶堆，然后挨个找
 *
 * @author pacman
 * @version 1.0
 * date: 2018/5/13 22:00
 */

public class Section30_MinK {

    public static void main(String[] args) {
        int[] nums = {3, 4, 2, 6, 5, 7, 1, 8};
        int[] results = new Section30_MinK().minK(nums, 3);
        System.out.println(Arrays.toString(results));
    }

    private int[] minK(int[] nums, int k) {
    ...
    /**
     * cp from https://blog.csdn.net/derrantcm/article/details/46736933
     *
     * @param <T>
     */
